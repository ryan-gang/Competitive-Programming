class Solution:
    ...
    def maxArea2(self, height: list[int]) -> int:
        ...
        (Also because, changing the longer stick, guarantees a lower area,
        reduced width, with same min height. So changing the longer stick
        doesn't make sense, but changing the shorter stick, we can atleast get something.)
